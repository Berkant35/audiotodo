                ...
                onPressed: () async {
                  ...
                  await ref
                    ...
                    if (value != null && value.isNotEmpty) {
                      ...
                      ref.read(currentBaseModelState
                          .notifier)
                      ...
                      ref
                          ...
                          .changeContentFlexibleManager(CustomFlexibleModel(
                              ...
                              content3:
                                  value.first.inspectionDate!.substring(0, 16),
                      ...
                      ref
                        ...
                        if (value.data() != null) {
                          ...
                          var expert = Expert.fromJson(customer.definedExpert);
                          ...
                          if ((ref.read(currentRole) == Roles.expert &&
                            ...
                            ref
                                ...
                                .changeContentFlexibleManager(CustomFlexibleModel(
                                    ...
                                    content5: newInspection.dangerLevelOfCustomer,
                                      ...
                                      return Padding(
                                        ...
                                        child: CustomCard(
                                            ...
                                            onClick: () async {
                                              ...
                                              ref.read(currentBaseModelState
                                                  .notifier)
                                                  .getCustomer(perInspection
                                                  .customerID!);

                                              debugPrint("test:${customer?.dangerLevel}");
                                              ref
                                                  .read(
                                                  ...
                                                  .changeContentFlexibleManager(
                                                      CustomFlexibleModel(
                                                          ...
                                                          header5: "Tehlike Durumu",
                                                          content4: customer!.companyDetectNumber!,
                                                          content5: perInspection.dangerLevelOfCustomer,
